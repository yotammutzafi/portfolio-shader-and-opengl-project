...
private:
	...
	Shader shader;
public:
	character_type_1_class(std::string path,int max_num_bones_per_vertex, glm::vec3 position,
	glm::vec3 sizes):
		...
		shader("shaders/vertex_shader_model", "shaders/fragment_shader_model"),
